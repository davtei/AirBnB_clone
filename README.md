#Airbnb Clone
This project is the first step towards building a full-stack web application similar to Airbnb. The first step is to write a command-line interpreter to manage the objects of the application.
...
A documentation is not a simple word, it’s a real sentence explaining what’s the purpose of the module, class or method (the length of it will be verified)I
